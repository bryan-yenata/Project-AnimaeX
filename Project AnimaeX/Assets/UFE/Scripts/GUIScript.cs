		...
		if (showControls && UFE.isPaused()){
			GUI.BeginGroup(new Rect(Screen.width / 2 - 250, Screen.height / 2 - 200, 500, 400));{
				...
				GUI.BeginGroup(new Rect(15, 0, 480, 400));{
					...
					GUILayout.BeginHorizontal();{
						if (showSpecials){
							if (GUILayout.Button("Controls")) showSpecials = false;
						}else{
							if (GUILayout.Button("Specials")) showSpecials = true;
						}
						GUILayout.FlexibleSpace();
						if (GUILayout.Button("Back")) showControls = false;
					}GUILayout.EndHorizontal();
			...
			GUI.BeginGroup(new Rect(Screen.width / 2 - 200, Screen.height / 2 - 130, 400, 260));{
				...
				GUI.BeginGroup(new Rect(15, 0, 380, 260));{
					...
					GUILayout.BeginHorizontal();{
						GUILayout.FlexibleSpace();
						if (GUILayout.Button("Controls", GUILayout.Width(200))) showControls = true;
						GUILayout.FlexibleSpace();
					}GUILayout.EndHorizontal();
					...
					GUILayout.BeginHorizontal();{
						GUILayout.FlexibleSpace();
						if (GUILayout.Button("Close")) UFE.PauseGame(false);
						GUILayout.FlexibleSpace();
					}GUILayout.EndHorizontal();
